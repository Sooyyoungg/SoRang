      ...
      <div class="jumbotron" sttle="background-color : #F8F8FF">
         <h1>Drink Detail</h1>
            ...
            <?php 
                ...
                //////////////전체 평균 별점 추가////////////////
                //사용자들의 평균 별점 출력
                $sql_count_review = "SELECT AVG(user_review.review_score) FROM user_review WHERE user_review.review_alc_name = '$alcname'";
                ...
                //해당 술에 대한 모든 리뷰 출력
                $sql_detail_drink = "SELECT * FROM user_review WHERE user_review.review_alc_name = '$alcname'";
